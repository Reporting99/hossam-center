...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: isAr 
      ? 'شروط وأحكام استخدام موقع مركز حسام لصيانة سيارات هوندا في عمان، الأردن.'
      : 'Terms and conditions for using the Hossam Honda Maintenance Center website in Amman, Jordan.',
